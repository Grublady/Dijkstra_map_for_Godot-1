...
@export var main_tile_layer: TileMapLayer
@export var cost_tile_layer: TileMapLayer
@export var direction_tile_layer: TileMapLayer
...
func on_visualization_selection_item_selected(index: int) -> void:
	var vis_layers: Array[TileMapLayer] = [cost_tile_layer, direction_tile_layer]
